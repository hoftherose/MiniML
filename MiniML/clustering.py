...
__all__ = ['Categorize', 'cat', 'plot_iris', 'k', 'it', 'data', 'centers', 'dist', 'get_distances', 'calc_centers',
           'np_results', 'results', 'c_flowers', 'one_hot', 'c_flowers', 'c_plot_iris', 'c_calc_centers', 'update_u',
           'distances', 'c_data', 'U', 'it', 'eps']
...
def c_plot_iris(data: pandas.core.frame.DataFrame):
    ...
    TOOLTIPS = """
        <div>
            ...
            <h3>categories:</h3> @setosa, @versicolor, @virginica
        </div>
    """
